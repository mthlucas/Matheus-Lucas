...
delete(instrfind({'Port'},{'COM3'})) % Limpar porta de comunicação serial
clear a;  % Limpar porta de comunicação serial
global a; 
a = arduino('COM3'); %Inicia uma nova comunicação Serial com o Arduino
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global a; %Para usar os comandos do arduino dentro da função
x=0; y=0; z=0;
for k=1:1:100 %Faz a leitura do sensor de 0 até 100
